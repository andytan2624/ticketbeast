...
class ConcertTest extends TestCase
{
    ...
    function can_order_concert_tickets()
    {
        ...
        $order = $concert->orderTickets('andy.tan2624@gmail.com', 3);

        $this->assertEquals('andy.tan2624@gmail.com', $order->email);
    ...
    function tickets_remaining_does_not_include_tickets_associated_with_an_order()
    {
        ...
        $concert->orderTickets('andy.tan2624@gmail.com', 30);
    ...
    function trying_to_purchase_more_tickets_than_remain_throws_an_exception()
    {
        ...
        try {
            ...
            $concert->orderTickets('andy.tan2624@gmail.com', 11);
        } catch (NotEnoughTicketsException $e) {
            $this->assertFalse($concert->hasOrderFor('andy.tan2624@gmail.com'));
            $this->assertEquals(10, $concert->ticketsRemaining());
            return;
        }

        $this->fail('Order succeeded even though there were not enough tickets remaiing');
    }
    ...
    function cannot_order_tickets_that_have_already_been_purchased()
    {
        ...
        $concert->orderTickets('andy.tan2624@gmail.com', 8);

        try {
            $concert->orderTickets('andy.tan2624+1@gmail.com', 3);
        } catch (NotEnoughTicketsException $e) {
            $jennysorder = $concert->orders()->where('email', 'andy.tan2624+1@gmail.com')->first();
            $this->assertNull($jennysorder);
    ...
    function cannot_reserve_tickets_that_have_already_been_purchased() {
        ...
        $this->fail('Reserving tickets succeeded eventhough the tickets were already sold.');
